 ...
 * @version 2.0
 * Description: The purpose of these file is to set to be the interface when the admin wants to update a task.
 *
 */
-->
    ...
    <div style="margin-top: 20px" class="container">
        ...
        <form action="update_task.php" method="post">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" id="task_owner" name="task_owner" value="<?php echo $row['Towner'] ?>">
            </div>
            <div class="form-group">
        ...
        <div>
            <br>
            <a href="view_tasks.php">Back to View all Task</a></br>
        </div>
