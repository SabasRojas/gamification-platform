 ...
 * @version 2.0
 * Description: The purpose of these file is to let the admin update a task.
 *
 */
-->
...
if (isset($_POST['Tname'])){
  ...
  $query = "UPDATE Task SET Tdescription='$tdescription',Towner='$towner',Type='$ttype',Tpoint_amount=$tpointamount,Tuser_needed=$tuserneeded,Ttime_frame='$ttimeframe' WHERE Tname = '$tname';";
    echo $query;
